      ...
      <CardDeck>
        <Row className="d-flex justify-content-around">
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2">
              <Card.Body>
                <Card.Title className="text-center  card-title">Cloud</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                  <span className="p-2">
                    <a className="text-dark text-decoration-none" href={skills.cloud[0].link} target="_blank" rel="noopener noreferrer">
                      <Image src={skills.cloud[0].imgSrc} alt={skills.cloud[0].imgAltText} rounded className="image-style m-1"></Image> {skills.cloud[0].skillName}
                    </a>
                  </span>
                </Card.Text>
              </Card.Body>
